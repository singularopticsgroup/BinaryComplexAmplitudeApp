...
## Related papers:
Przemyslaw Litwin, Kamil Kalinowski, Jakub Wroński, Mateusz Szatkowski, “Binary Complex Amplitude Application: an all-in-one Matlab application for the advanced laser beam shaping with digital micromirror device” , SoftwareX 27, 101870 (2024).
